...
const App = () => {
  ...
  const dummyData = {
    ...
    // Add your greetings and FAQs here for the provided logic to work
    greetings: [
      'أهلاً وسهلاً بك في متجرنا! أنا هنا لمساعدتك في أي شيء تحتاجه.',
      'مرحباً يا صديقي! كيف يمكنني أن أجعلك سعيداً اليوم؟',
      'يا هلا بك! أنا مساعدك الشخصي في المتجر، تحت أمرك.',
    ],
    faqs: [
      {
        keywords: ['طرق الدفع', 'كيف أدفع', 'الدفع'],
        answer: 'بالتأكيد! يمكنك الدفع باستخدام البطاقات الائتمانية (فيزا، ماستركارد)، مدى، أبل باي، وأحياناً الدفع عند الاستلام. هل تفضل طريقة معينة؟'
      },
      {
        keywords: ['مدة الشحن', 'متى توصل', 'التوصيل', 'الشحن'],
        answer: 'عادةً ما يستغرق الشحن داخل المدن الرئيسية من 2-4 أيام عمل، وللمناطق الأخرى قد يصل إلى 5-7 أيام عمل. أنتظر بفارغ الصبر وصول طلبك لك!'
      },
      {
        keywords: ['سياسة الإرجاع', 'إرجاع', 'استرجاع منتج'],
        answer: 'يمكنك إرجاع أي منتج خلال 14 يوماً من تاريخ الاستلام بشرط أن يكون في حالته الأصلية. لا تقلق، العملية بسيطة جداً. هل لديك منتج معين تود إرجاعه؟'
      },
      {
        keywords: ['كيف أتتبع طلبي', 'تتبع طلبي', 'تتبع شحنة'],
        answer: 'يمكنك تتبع طلبك بكل سهولة عن طريق زيارة صفحة "تتبع الطلبات" وإدخال رقم طلبك. هل لديك رقم الطلب الآن؟'
      },
      {
        keywords: ['خدمة العملاء', 'أتواصل', 'رقمكم', 'تليفون'],
        answer: 'فريقنا مستعد دائماً لمساعدتك! يمكنك التواصل مع خدمة العملاء على الرقم 92000xxxx أو عبر البريد الإلكتروني support@yourstore.com. نحن متواجدون من الأحد إلى الخميس من 9 صباحاً حتى 5 مساءً.'
      },
      {
        keywords: ['تغليف الهدايا', 'تغليف هدية'],
        answer: 'فكرة رائعة! نعم، نوفر خدمة تغليف الهدايا بلمسة أنيقة مقابل رسوم بسيطة. يمكنك اختيارها عند إتمام الشراء.'
      },
      {
        keywords: ['الدفع بالتقسيط', 'قسط', 'تقسيط'],
        answer: 'نعم، نوفر خدمة الدفع بالتقسيط عبر تمارا وتابي، حتى تتمكن من الحصول على ما تريد الآن وتدفع لاحقاً بدون فوائد. هل هذا يهمك؟'
      },
      {
        keywords: ['عروض', 'خصومات', 'تخفيضات'],
