...
const App = () => {
  ...
  const dummyData = {
    products: [
      ...
      { "id": "h21", "name": "بنطلون جينز سكيني نسائي", "brand": "Zara", "category": "ملابس", "price": 820, "description": "بنطلون جينز بقصة سكيني مريح، خصر متوسط ومرونة عالية للحركة اليومية.", "colors": ["أزرق فاتح", "أسود"], "sizes": ["S", "M", "L", "XL"], "imageUrl": "https://example.com/women-skinny-jeans.jpg" },
      { "id": "h22", "name": "تيشيرت رجالي قطن برسمة", "brand": "Bershka", "category": "ملابس", "price": 450, "description": "تيشيرت قطن 100% برسمة عصرية على الصدر، مناسب للارتداء اليومي.", "colors": ["أبيض", "أسود", "رمادي"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/men-graphic-tee.jpg" },
      { "id": "h23", "name": "فستان شيفون طويل", "brand": "H&M", "category": "ملابس", "price": 1150, "description": "فستان أنيق من الشيفون بقصة واسعة وأكمام طويلة، مثالي للمناسبات.", "colors": ["كحلي", "روز", "أخضر زمردي"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/chiffon-dress.jpg" },
      { "id": "h24", "name": "هودي رجالي شتوي مبطن", "brand": "Pull&Bear", "category": "ملابس", "price": 990, "description": "هودي دافئ مبطن بفرو داخلي لراحة مثالية في الشتاء، تصميم بغطاء رأس.", "colors": ["رمادي", "زيتي", "أسود"], "sizes": ["M", "L", "XL", "XXL"], "imageUrl": "https://example.com/mens-hoodie.jpg" },
      { "id": "h25", "name": "طقم أطفال شتوي بناتي", "brand": "LC Waikiki", "category": "ملابس", "price": 720, "description": "طقم مكوّن من سويت شيرت وبنطلون قطني برسومات كرتونية.", "colors": ["وردي", "أبيض"], "sizes": ["2Y", "4Y", "6Y"], "imageUrl": "https://example.com/girls-winter-set.jpg" },
      { "id": "h26", "name": "قميص رسمي رجالي كلاسيك", "brand": "Massimo Dutti", "category": "ملابس", "price": 1300, "description": "قميص كلاسيك بأكمام طويلة وخامة فاخرة مناسب للبدلات الرسمية.", "colors": ["أبيض", "أزرق فاتح", "رمادي"], "sizes": ["M", "L", "XL", "XXL"], "imageUrl": "https://example.com/mens-formal-shirt.jpg" },
      { "id": "h27", "name": "بلوزة نسائية دانتيل", "brand": "Stradivarius", "category": "ملابس", "price": 880, "description": "بلوزة دانتيل أنثوية بأكمام شفافة، مثالية للخروج الليلي أو المناسبات.", "colors": ["أسود", "كريمي"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/women-lace-blouse.jpg" },
      { "id": "h28", "name": "بنطلون رياضي رجالي", "brand": "Nike", "category": "ملابس", "price": 1150, "description": "بنطلون رياضي مريح بخامة مقاومة للعرق وشريط مطاطي على الخصر.", "colors": ["رمادي", "أسود"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/men-sweatpants.jpg" },
      { "id": "h29", "name": "كارديجان شتوي نسائي", "brand": "Reserved", "category": "ملابس", "price": 1020, "description": "كارديجان طويل بأزرار وأكمام واسعة، خامة ناعمة ودافئة.", "colors": ["بيج", "رمادي", "أحمر"], "sizes": ["S", "M", "L", "XL"], "imageUrl": "https://example.com/women-cardigan.jpg" },
      { "id": "h30", "name": "جاكيت أطفال مبطن", "brand": "Defacto", "category": "ملابس", "price": 950, "description": "جاكيت مبطن مقاوم للماء، خفيف الوزن ودافئ، مزود بغطاء رأس.", "colors": ["أزرق", "أحمر"], "sizes": ["2Y", "4Y", "6Y", "8Y"], "imageUrl": "https://example.com/kids-jacket.jpg" },
      { "id": "h31", "name": "تنورة قصيرة جينز نسائي", "brand": "Zara", "category": "ملابس", "price": 730, "description": "تنورة جينز قصيرة بكسرات أمامية، تصميم شبابي وعصري.", "colors": ["أزرق", "أسود"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/denim-skirt.jpg" },
      { "id": "h32", "name": "تيشيرت أطفال برسمة ميكي", "brand": "LC Waikiki", "category": "ملابس", "price": 350, "description": "تيشيرت قطني برسمة ميكي ماوس، مناسب للصيف ومريح للبشرة الحساسة.", "colors": ["أبيض", "أصفر", "أحمر"], "sizes": ["2Y", "4Y", "6Y"], "imageUrl": "https://example.com/mickey-kids-tee.jpg" },
      { "id": "h33", "name": "جاكيت بليزر رسمي نسائي", "brand": "H&M", "category": "ملابس", "price": 1400, "description": "جاكيت بليزر أنيق بلون سادة، تصميم مناسب للعمل والمقابلات.", "colors": ["أسود", "كحلي"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/women-blazer.jpg" },
      { "id": "h34", "name": "بيجامة رجالي قطن صيفي", "brand": "Max", "category": "ملابس", "price": 680, "description": "طقم بيجامة قطني خفيف للرجال، تيشيرت + شورت بألوان محايدة.", "colors": ["أزرق", "رمادي"], "sizes": ["M", "L", "XL", "XXL"], "imageUrl": "https://example.com/men-summer-pjs.jpg" },
      { "id": "h35", "name": "فستان قصير بأزرار أمامية", "brand": "Stradivarius", "category": "ملابس", "price": 970, "description": "فستان صيفي قصير بأزرار أمامية، تصميم بسيط وجذاب.", "colors": ["أصفر", "أبيض", "أخضر"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/buttoned-dress.jpg" },
      { "id": "h36", "name": "سويت شيرت مطبوع رجالي", "brand": "Bershka", "category": "ملابس", "price": 790, "description": "سويت شيرت ببرنت جرافيكي شبابي، مناسب للخريف والشتاء.", "colors": ["أسود", "زيتي"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/graphic-sweatshirt.jpg" },
      { "id": "h37", "name": "بنطلون واسع نسائي", "brand": "Mango", "category": "ملابس", "price": 890, "description": "بنطلون بقصة واسعة من خامة خفيفة، مثالي للمظهر الرسمي أو الكاجوال.", "colors": ["بيج", "أسود", "رمادي"], "sizes": ["S", "M", "L", "XL"], "imageUrl": "https://example.com/wide-pants.jpg" },
      { "id": "h38", "name": "قميص كاجوال بكم قصير رجالي", "brand": "Zara Man", "category": "ملابس", "price": 670, "description": "قميص بأزرار وكم قصير برسمة مربعات، خامة خفيفة ومناسبة للصيف.", "colors": ["أبيض × أزرق", "أبيض × أحمر"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/casual-shirt.jpg" },
      { "id": "h39", "name": "جاكيت دنيم نسائي", "brand": "Pull&Bear", "category": "ملابس", "price": 1100, "description": "جاكيت جينز بتصميم كاجوال وأزرار أمامية، أساسي في كل خزانة.", "colors": ["أزرق", "أسود"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/women-denim-jacket.jpg" },
      { "id": "h40", "name": "طقم بيجامة أطفال قطني", "brand": "Carter's", "category": "ملابس", "price": 590, "description": "بيجامة ناعمة للأطفال تحتوي على تيشيرت وبنطلون برسمة نجوم.", "colors": ["وردي", "لبني", "رمادي"], "sizes": ["2Y", "4Y", "6Y", "8Y"], "imageUrl": "https://example.com/kids-pajama.jpg" },
      { "id": "h41", "name": "جاكيت رجالي جلد كلاسيك", "brand": "Zara", "category": "جاكيت", "price": 1100, "description": "جاكيت رجالي من الجلد الطبيعي بتصميم كلاسيكي أنيق، مثالي لفصل الشتاء والمناسبات.", "colors": ["أسود", "بني"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/images/h41.jpg" },
      { "id": "h42", "name": "فستان حريمي دانتيل سواريه", "brand": "H&M", "category": "فساتين", "price": 1250, "description": "فستان سواريه من الدانتيل الفاخر بتصميم أنيق، مناسب للحفلات والسهرات.", "colors": ["كحلي", "أحمر", "ذهبي"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/images/h42.jpg" },
      { "id": "h43", "name": "قميص رجالي كتان صيفي", "brand": "Pull&Bear", "category": "قمصان", "price": 440, "description": "قميص خفيف من الكتان مثالي للأيام الحارة، بتصميم أنيق وسهل التنسيق.", "colors": ["أبيض", "أزرق فاتح"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/images/h43.jpg" },
      { "id": "h44", "name": "بلوزة حريمي كم طويل شيفون", "brand": "Stradivarius", "category": "بلوزات", "price": 360, "description": "بلوزة أنيقة من الشيفون بكم طويل، مناسبة للعمل والخروج اليومي.", "colors": ["أسود", "روز", "بيج"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/images/h44.jpg" },
      { "id": "h45", "name": "سويت شيرت رجالي كاجوال", "brand": "Nike", "category": "سويت شيرت", "price": 780, "description": "سويت شيرت رياضي عملي ومريح مصنوع من خامة قطنية ناعمة.", "colors": ["رمادي", "أزرق", "زيتي"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/images/h45.jpg" },
      { "id": "h46", "name": "تنورة (جيب) حريمي قصيرة جينز", "brand": "Bershka", "category": "جيبات", "price": 340, "description": "تنورة جينز قصيرة بتصميم عصري، تناسب الإطلالات الشبابية.", "colors": ["أزرق جينز", "أسود"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/images/h46.jpg" },
      { "id": "h47", "name": "بيجامة رجالي قطن صيفي", "brand": "LC Waikiki", "category": "بيجامات", "price": 410, "description": "طقم بيجامة قطنية خفيفة تتكون من تيشرت وشورت، مثالي للنوم في الصيف.", "colors": ["أبيض × كحلي", "رمادي × أسود"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/images/h47.jpg" },
      { "id": "h48", "name": "جاكيت جينز حريمي", "brand": "Stradivarius", "category": "جاكيت", "price": 650, "description": "جاكيت جينز أنيق بقصة قصيرة، يناسب جميع الإطلالات اليومية.", "colors": ["جينز فاتح", "جينز غامق"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/images/h48.jpg" },
      { "id": "h49", "name": "تيشرت رجالي بطبعة جرافيك", "brand": "Defacto", "category": "تيشرتات", "price": 240, "description": "تيشرت قطن برسمة جرافيك مميزة، مناسب للستايل الشبابي العصري.", "colors": ["أسود", "أبيض", "زيتي"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/images/h49.jpg" },
      { "id": "h50", "name": "عباية حريمي كاجوال", "brand": "Al Rashed", "category": "عبايات", "price": 720, "description": "عباية قماش كريب ناعم تصميم عصري وخفيف، مناسبة للزي اليومي.", "colors": ["أسود", "رمادي", "نيلي"], "sizes": ["Free Size"], "imageUrl": "https://example.com/images/h50.jpg" },
      { "id": "h51", "name": "كارديجان شتوي رجالي", "brand": "Zara Man", "category": "كارديجان", "price": 830, "description": "كارديجان من الصوف السميك بستايل مفتوح، مثالي لأجواء الشتاء الباردة.", "colors": ["رمادي غامق", "بيج", "أسود"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/images/h51.jpg" },
      { "id": "h52", "name": "قميص حريمي مشجر شيفون", "brand": "New Look", "category": "قمصان", "price": 385, "description": "قميص شيفون مشجر بألوان هادئة، تصميم خفيف ومناسب للصيف.", "colors": ["وردي × أبيض", "كحلي × بيج"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/images/h52.jpg" },
      { "id": "h53", "name": "بنطلون رجالي رسمي", "brand": "Massimo Dutti", "category": "بنطلونات", "price": 690, "description": "بنطلون رسمي بقصة مستقيمة، خامة ناعمة وقابلة للكي بسهولة.", "colors": ["أسود", "رمادي", "كحلي"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/images/h53.jpg" },
      { "id": "h54", "name": "بلوزة حريمي قطن سادة", "brand": "Mango", "category": "بلوزات", "price": 295, "description": "بلوزة قطنية سادة مناسبة للعمل والخروجات اليومية بتصميم بسيط وراقي.", "colors": ["أبيض", "أزرق سماوي", "روز"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/images/h54.jpg" },
      { "id": "h55", "name": "تيشرت بولو رجالي", "brand": "Lacoste", "category": "بولو", "price": 870, "description": "تيشرت بولو كلاسيكي أنيق، يناسب الطابع الرياضي والرسمي.", "colors": ["أبيض", "أخضر", "كحلي"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/images/h55.jpg" },
      { "id": "h56", "name": "بيجامة حريمي ستان شتوي", "brand": "Oysho", "category": "بيجامات", "price": 580, "description": "طقم بيجامة من قماش ستان ناعم بتصميم أنيق ودافئ.", "colors": ["خمري", "أزرق داكن"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/images/h56.jpg" },
      { "id": "h57", "name": "هودي رجالي بغطاء رأس", "brand": "Adidas", "category": "هودي", "price": 760, "description": "هودي قطن مريح عملي للرياضة أو الخروج بتصميم حديث.", "colors": ["أسود", "رمادي", "أزرق"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/images/h57.jpg" },
      { "id": "h58", "name": "جيبة طويلة حريمي بليسيه", "brand": "H&M", "category": "جيبات", "price": 410, "description": "تنورة طويلة بليسيه مناسبة للإطلالات الكاجوال والعملية.", "colors": ["أسود", "زيتي", "بيج"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/images/h58.jpg" },
      { "id": "h59", "name": "قميص رجالي بخطوط طولية", "brand": "Springfield", "category": "قمصان", "price": 430, "description": "قميص بألوان متداخلة بخطوط طولية يعطيك مظهرًا عصريًا أنيقًا.", "colors": ["كحلي × أبيض", "رمادي × أسود"], "sizes": ["M", "L", "XL"], "imageUrl": "https://example.com/images/h59.jpg" },
      { "id": "h60", "name": "كارديجان طويل حريمي", "brand": "Zara Woman", "category": "كارديجان", "price": 740, "description": "كارديجان طويل دافئ بتصميم مريح وأنيق يناسب الشتاء.", "colors": ["رمادي", "بيج", "أسود"], "sizes": ["S", "M", "L"], "imageUrl": "https://example.com/images/h60.jpg" },
      // Home Appliances
    ...
    // Add your greetings and FAQs here for the provided logic to work
    greetings: [
      'أهلاً بك في متجرنا! كيف يمكنني مساعدتك اليوم؟',
      'مرحباً! أنا مساعدك الشخصي في المتجر. ما الذي تبحث عنه؟',
      'مرحباً، يسعدني مساعدتك. تفضل بالسؤال!',
    ],
    faqs: [
      {
        keywords: ['طرق الدفع', 'كيف أدفع', 'الدفع'],
        answer: 'نحن نقبل الدفع عبر بطاقات الائتمان (فيزا، ماستركارد)، مدى، أبل باي، والدفع عند الاستلام في بعض المناطق. هل تفضل طريقة دفع معينة؟'
      },
      {
        keywords: ['مدة الشحن', 'متى توصل', 'التوصيل', 'الشحن'],
        answer: 'عادةً ما يستغرق الشحن داخل المدن الرئيسية من 2-4 أيام عمل، وللمناطق الأخرى قد يستغرق من 5-7 أيام عمل. هل تبحث عن معلومات شحن لطلب معين؟'
      },
      {
        keywords: ['سياسة الإرجاع', 'إرجاع', 'استرجاع منتج'],
        answer: 'يمكنك إرجاع أي منتج خلال 14 يوماً من تاريخ الاستلام بشرط أن يكون بحالته الأصلية وغير مستخدم. لمزيد من التفاصيل، يرجى زيارة صفحة سياسة الإرجاع على موقعنا.'
      },
      {
        keywords: ['كيف أتتبع طلبي', 'تتبع طلبي', 'تتبع شحنة'],
        answer: 'يمكنك تتبع طلبك من خلال زيارة صفحة "تتبع الطلبات" على موقعنا وإدخال رقم طلبك. هل لديك رقم طلب حالي؟'
      },
      {
        keywords: ['خدمة العملاء', 'أتواصل', 'رقمكم', 'تليفون'],
        answer: 'يمكنك التواصل مع خدمة العملاء لدينا عبر الرقم 92000xxxx أو عبر البريد الإلكتروني support@yourstore.com. نحن متاحون من الأحد إلى الخميس من 9 صباحاً حتى 5 مساءً.'
      },
      {
        keywords: ['تغليف الهدايا', 'تغليف هدية'],
        answer: 'نعم، نوفر خدمة تغليف الهدايا لجميع المنتجات مقابل رسوم إضافية بسيطة. يمكنك اختيار هذه الخدمة عند إتمام عملية الشراء.'
      },
      {
        keywords: ['الدفع بالتقسيط', 'قسط', 'تقسيط'],
        answer: 'نقدم خدمة الدفع بالتقسيط عبر تمارا وتابي، مما يتيح لك تقسيم المبلغ على دفعات مريحة بدون فوائد. يمكنك معرفة المزيد عند صفحة الدفع.'
      },
      {
        keywords: ['عروض', 'خصومات', 'تخفيضات'],
        answer: 'لدينا دائمًا عروض وخصومات مميزة! يمكنك زيارة قسم "العروض الخاصة" على موقعنا للاطلاع على أحدث التخفيضات المتاحة.'
      },
      {
        keywords: ['متى تفتحون', 'مواعيد العمل'],
        answer: 'متجرنا الإلكتروني متاح 24/7 لأخذ طلباتك! أما فريق خدمة العملاء فيعمل من الأحد إلى الخميس، من الساعة 9 صباحًا حتى 5 مساءً.'
      },
    ],
  };
  ...
  const getBotResponse = async (message) => {
    ...
    if (priceMatchUnder) {
      ...
      if (filteredByPrice.length > 0) {
        ...
        return { type: 'text', text: `بالتأكيد! إليك بعض المنتجات المميزة التي تقع ضمن ميزانيتك (تحت ${maxPrice} ريال):\n${productDetails}. هل ترغب في معرفة المزيد عن أي من هذه المنتجات؟` };
      } else {
        return { type: 'text', text: `عذرًا، لم أجد أي منتجات تحت ${maxPrice} ريال في قائمتنا حاليًا. ربما يمكنك رفع الميزانية قليلاً أو البحث في فئة أخرى؟` };
      }
      ...
      if (filteredByPrice.length > 0) {
        const productDetails = filteredByPrice.map(p => `${p.name} (${p.price} ريال)`).join('، ');
        return { type: 'text', text: `بالتأكيد! إليك بعض المنتجات المميزة التي تزيد عن ${minPrice} ريال:\n${productDetails}. هل ترغب في معرفة المزيد عن أي من هذه المنتجات؟` };
      } else {
        return { type: 'text', text: `عذرًا، لم أجد أي منتجات تزيد عن ${minPrice} ريال في قائمتنا حاليًا. ربما يمكنك تجربة سعر أقل أو تصفح فئات أخرى؟` };
      }
    }
    ...
    if (productFoundInDummyData) {
      let responseText = '';
      if (isPriceInquiry) {
        responseText = `سعر ${productFoundInDummyData.name} هو ${productFoundInDummyData.price} ريال.`;
        ...
        responseText = `براند ${productFoundInDummyData.name} هو ${productFoundInDummyData.brand}.`;
      } else {
    ...
    if (lowerCaseMessage.includes('منتجات') || lowerCaseMessage.includes('ماذا تبيعون') || lowerCaseMessage.includes('قائمة المنتجات') || lowerCaseMessage.includes('كل المنتجات')) {
      ...
      return { type: 'text', text: `لدينا تشكيلة واسعة من المنتجات الرائعة! تشمل: ${productList}. يمكنك سؤالي عن أي منتج أو فئة معينة.` };
    }
    ...
    if (lowerCaseMessage.includes('اقترحلي هدية') || lowerCaseMessage.includes('هدية') && !priceCriteriaMet) { // Ensure not confused with price inquiries
      return { type: 'text', text: 'فكرة رائعة! لمساعدتي في اختيار الهدية المثالية، من فضلك أخبرني:\n1. لمن هذه الهدية (مثل: لأمي، لأبي، لصديق، لطفل)؟\n2. ما هي المناسبة؟\n3. ما هي الميزانية التقريبية؟\n4. ما هي اهتمامات الشخص (مثل: يحب التقنية، يحب الموضة، يهوى الرياضة)؟' };
    }
    ...
    if (lastBotMessage && lastBotMessage.includes('لمساعدتي في اختيار الهدية المثالية')) {
      ...
      if (potentialGifts.length > 0) {
        ...
        return { type: 'text', text: 'لم أتمكن من العثور على هدية تطابق كل المعايير بالضبط. هل يمكنك إعطائي تفاصيل أكثر أو ميزانية مختلفة؟' };
      }
    }
    ...
    try {
      ...
      // Prepare chat history for Gemini, excluding the current message as it's part of the prompt
